import 'package:chasky/src/models/mercado_pago_card_holder.dart';
import 'package:chasky/src/models/mercado_pago_issuer.dart';
import 'package:chasky/src/models/mercado_pago_payment_method.dart';
import 'package:chasky/src/models/mercado_pago_security_code.dart';
...
class MercadoPagoCreditCard {
  ...
  MercadoPagoCreditCard.fromJson(Map<String, dynamic> json) {
    ...
    userId = json['user_id'];
    expirationMonth =
        (json['expiration_month'] != null)
            ? int.parse(json['expiration_month'].toString())
            : 0;
    expirationYear =
        (json['expiration_year'] != null)
