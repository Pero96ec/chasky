import 'package:chasky/src/models/mercado_pago_credit_cart.dart';
import 'package:chasky/src/models/mercado_pago_customer.dart';
import 'package:chasky/src/models/mercado_pago_tax.dart';
import 'package:chasky/src/models/mercado_pago_transaction_detail.dart';
...
class MercadoPagoPayment {
  ...
  MercadoPagoPayment.fromJson(Map<String, dynamic> json) {
    ...
    payer =
        json['payer'] is MercadoPagoCustomer
            ? json['payer']
    ...
    transactionAmountRefunded =
        (json['transaction_amount_refunded'] != null)
    ...
    installments =
        (json['installments'] != null)
            ...
            : 0;
    card =
        json['card'] is MercadoPagoCreditCard
            ? json['card']
