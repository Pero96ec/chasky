...
import 'package:chasky/src/models/product.dart';
import 'package:chasky/src/models/user.dart';
import 'package:chasky/src/pages/restaurant/orders/detail/restaurant_orders_detail_controller.dart';
import 'package:chasky/src/utils/relative_time_util.dart';
import 'package:chasky/src/widgets/no_data_widget.dart';

class RestaurantOrdersDetailPage extends StatelessWidget {
  RestaurantOrdersDetailController con = Get.put(
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => Scaffold(
        ...
        body:
            con.order.products!.isNotEmpty
                ? ListView(
                  children:
                      con.order.products!.map((Product product) {
      ...
      children: [
        ...
        Container(
          margin: EdgeInsets.only(
            left: con.order.status == 'PAGADO' ? 30 : 37,
            top: 15,
          ),
          child: Row(
            mainAxisAlignment:
  ...
  Widget _dropDownDeliveryMen(List<User> users) {
    return Container(
      ...
      child: DropdownButton(
        ...
        elevation: 3,
        isExpanded: true,
        hint: Text('Seleccionar repartidor', style: TextStyle(fontSize: 15)),
