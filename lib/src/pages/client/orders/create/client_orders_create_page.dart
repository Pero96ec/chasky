...
import 'package:chasky/src/pages/client/orders/create/client_orders_create_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => Scaffold(
        ...
        body:
            con.selectedProducts.length > 0
                ? ListView(
                  children:
                      con.selectedProducts.map((Product product) {
