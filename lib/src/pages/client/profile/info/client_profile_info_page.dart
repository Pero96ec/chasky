...
import 'package:chasky/src/pages/client/profile/info/client_profile_info_controller.dart';
      ...
      body: Obx(
        () => Stack(
          ...
          children: [
            ...
            _boxForm(context),
            _imageUser(context),
            Column(children: [_buttonSignOut(), _buttonRoles()]),
          ],
        ),
      ),
    );
  ...
  Widget _buttonUpdate(BuildContext context) {
    return Container(
      ...
      child: ElevatedButton(
        ...
        child: Text('ACTUALIZAR DATOS', style: TextStyle(color: Colors.black)),
      ),
    );
  }
