...
import 'package:chasky/src/pages/client/payments/status/client_payments_status_controller.dart';

class ClientPaymentsStatusPage extends StatelessWidget {
  ClientPaymentsStatusController con = Get.put(
  ...
  Widget _buttonCreate(BuildContext context) {
    return Container(
      ...
      child: ElevatedButton(
        ...
        child: Text('FINALIZAR COMPRA', style: TextStyle(color: Colors.black)),
      ),
    );
  }
